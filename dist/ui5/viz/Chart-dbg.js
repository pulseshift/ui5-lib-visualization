 ...
 * </Chart>
 */
sap.ui.define(['sap/ui/core/Control', 'sap/ui/core/format/DateFormat', './ChartAxis', './ChartAxisLabel', './libs/lodash.debounce', './libs/lodash.isequal', './libs/lodash.defer', './libs/d3', './libs/c3', './library'], function (Control, DateFormat, ChartAxis, ChartAxisLabel, lodashDebounce, lodashIsequal, lodashDefer) {
  var d3 = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : window.d3;
  var c3 = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : window.c3;
  var library = arguments.length > 9 ? arguments[9] : undefined;
  ...
  return Control.extend('ui5.viz.Chart', {
    ...
    init: function init() {
      ...
      this._initNumberRangeCreator(); // this._initChartUpdateHandler()
    ...
    /* oModel, sName */
    {
      ...
      // this._getChartUpdateHandler().halt()
      Control.prototype.setModel.apply(this, arguments); // this._getChartUpdateHandler().release()
      ...
      this.getSeries().forEach(function (oSeries) {
        ...
        switch (sShapeStyle) {
          case library.ShapeStyle.Striped:
            ...
            if (oPattern.empty()) {
              oPattern = d3.select("#".concat(sChartHtmlID, " defs")).append('pattern').attr('id', "".concat(sChartHtmlID, "-stripe-pattern-").concat(sSeriesHtmlID)).attr('width', '8').attr('height', '8').attr('patternUnits', 'userSpaceOnUse').attr('class', "stripe-pattern-".concat(sSeriesHtmlID)).append('path').attr('d', 'M1,0L5,0L0,5L0,1L1,0 M8,1L8,5L5,8L1,8L8,1');
            ...
            if (oPatternStyle.empty()) {
              oPatternStyle = d3.select("#".concat(sChartHtmlID, " defs")).append('style').attr('id', "".concat(sChartHtmlID, "-stripe-style-").concat(sSeriesHtmlID)).attr('type', 'text/css');
        ...
        switch (sLineStyle) {
          ...
          case library.LineStyle.Dotted:
            ...
            if (oStrokeStyle.empty()) {
              oStrokeStyle = d3.select("#".concat(sChartHtmlID, " defs")).append('style').attr('id', "".concat(sChartHtmlID, "-dashdot-style-").concat(sSeriesHtmlID)).attr('type', 'text/css');
            } // update svg pattern style
    ...
    _updateLineStyles: function _updateLineStyles() {
      ...
      if (oLineStyle.empty()) {
        oLineStyle = d3.select("#".concat(sChartHtmlID, " defs")).append('style').attr('id', "".concat(sChartHtmlID, "-line-style")).attr('type', 'text/css');
      ...
      this.getLines().forEach(function (oLine) {
        ...
        switch (sLineStyle) {
          ...
          case library.LineStyle.Dotted:
            ...
            if (oStrokeStyle.empty()) {
              oStrokeStyle = d3.select("#".concat(sChartHtmlID, " defs")).append('style').attr('id', "".concat(sUID)).attr('type', 'text/css');
            } // update svg pattern style
    ...
    _updateAreaStyles: function _updateAreaStyles() {
      ...
      if (oAreaStyle.empty()) {
        oAreaStyle = d3.select("#".concat(sChartHtmlID, " defs")).append('style').attr('id', "".concat(sChartHtmlID, "-area-style")).attr('type', 'text/css');
      ...
      this.getAreas().forEach(function (oArea) {
        ...
        switch (sShapeStyle) {
          case library.ShapeStyle.Striped:
            ...
            if (oPattern.empty()) {
              oPattern = d3.select("#".concat(sChartHtmlID, " defs")).append('pattern').attr('id', "".concat(sChartHtmlID, "-area-stripe-pattern-").concat(sAreaHtmlID)).attr('width', '8').attr('height', '8').attr('patternUnits', 'userSpaceOnUse').attr('class', "area-stripe-pattern-".concat(sAreaHtmlID)).append('path').attr('d', 'M1,0L5,0L0,5L0,1L1,0 M8,1L8,5L5,8L1,8L8,1');
            } // update svg area style
