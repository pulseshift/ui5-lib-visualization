...
(function (window) {
    ...
    c3_chart_internal_fn.redrawGrid = function (withTransition) {
        ...
        return [(withTransition ? lines.transition() : lines).attr("x1", config.axis_rotated ? function (d) {
            return d.showSelector ? 35 : 0;
        } : xv).attr("x2", config.axis_rotated ? $$.width : xv)
        // === START PULSESHIFT CUSTOM EXTENSION ===
